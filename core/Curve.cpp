...
namespace holubiho {
    Curve::Curve(std::vector<glm::vec3>& control_points) : controlPoints(std::move(control_points)) {
        ...
        size_t Curve::findStartKnot(float t) {
        ...
        std::vector<double> Curve::weightFunc(size_t i, double t) {
            double level1[4];
            double level2[3];
            double level3[2];
            double level4;
        ...
        Curve Curve::createClosedLoop(const std::vector<glm::vec3>& control_points) {
